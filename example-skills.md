...
ASK FIRST
At most three questions before you start, only the ones that would change
the plan most: usually the date, the budget ceiling, and whether it's
in-person only. If I already gave you those, don't ask. Start.
